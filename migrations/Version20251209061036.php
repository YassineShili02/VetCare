 ...
 */
final class Version20251209061036 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clinique (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(10) DEFAULT NULL, ville VARCHAR(100) DEFAULT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, horaires_ouverture JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', site_web VARCHAR(255) DEFAULT NULL, actif TINYINT(1) NOT NULL, logo VARCHAR(255) DEFAULT NULL, services JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', tarif_consultation NUMERIC(10, 2) DEFAULT NULL, note_globale DOUBLE PRECISION DEFAULT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
