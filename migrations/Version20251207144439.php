 ...
 */
final class Version20251207144439 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE clinique (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, code_postal VARCHAR(10) DEFAULT NULL, ville VARCHAR(100) DEFAULT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, horaires_ouverture LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', site_web VARCHAR(255) DEFAULT NULL, actif TINYINT(1) NOT NULL, logo VARCHAR(255) DEFAULT NULL, services LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', tarif_consultation NUMERIC(10, 2) DEFAULT NULL, note_globale DOUBLE PRECISION DEFAULT NULL, date_creation DATETIME NOT NULL, date_modification DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE dossier_medical (id_dossier INT AUTO_INCREMENT NOT NULL, animal_id INT DEFAULT NULL, numero_dossier VARCHAR(255) NOT NULL, date_creation DATETIME NOT NULL, poids DOUBLE PRECISION DEFAULT NULL, etat VARCHAR(255) NOT NULL, images LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', notes_veterinaire VARCHAR(255) DEFAULT NULL, allergies VARCHAR(255) DEFAULT NULL, vaccinations VARCHAR(255) DEFAULT NULL, antecedents_medicaux VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_3581EE628E962C16 (animal_id), PRIMARY KEY(id_dossier)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
